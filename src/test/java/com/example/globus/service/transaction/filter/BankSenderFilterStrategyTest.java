...
class BankSenderFilterStrategyTest {

    @InjectMocks
    private BankSenderFilterStrategy strategy;
    ...
    @Mock
    private Path<Object> bankSenderPath;

    @Mock
    private Path<Object> idPath;

    @Test
    void supports_shouldReturnTrue_whenBankSenderIdIsNotNull() {
        // Arrange
    ...
    @Test
    void supports_shouldReturnFalse_whenBankSenderIdIsNull() {
        // Arrange
        TransactionFilterDTO filter = new TransactionFilterDTO(
                null, 1L, null, null, 
                null, null, null, null, 
    ...
    void createPredicate_shouldCreateEqualPredicate() {
        ...
        when(root.get("bankSender")).thenReturn(bankSenderPath);
        when(bankSenderPath.get("id")).thenReturn(idPath);
